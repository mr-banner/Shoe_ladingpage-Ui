...
const Hero = () => {
  return (
    ...
    >
      ...
      <div className="flex relative flex-1 justify-center items-center xl:min-h-screen bg-hero bg-cover bg-center bg-primary">
          <img src={bigShoe1} alt="Shoe Collection" className="relative z-10 object-contain" />
      </div>
    </section>
  );
};
